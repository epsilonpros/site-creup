          ...
          <div className="text-center">
            ...
            <div className="mt-20 grid animate-fade-in-up-delay-3 grid-cols-1 gap-8 md:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:border-white/20">
                ...
                <h3 className="mb-2 text-lg font-semibold text-white">{stats?.project} Projets</h3>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm transition-all hover:border-white/20">
                ...
                <h3 className="mb-2 text-lg font-semibold text-white">{stats?.expert} Experts</h3>
            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-6 flex items-center text-sm font-medium text-primary-500">
                    En savoir plus
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            {partners
              ...
              .map((partner) => (
                <div
                  key={partner.id}
                  className="flex flex-col items-center justify-center rounded-lg border border-gray-100 bg-white p-8"
                >
                  <img
                    src={partner.logo}
                    alt={partner.name}
                  ...
                  />
                  <span className="text-sm font-medium text-gray-600">{partner.category}</span>
                </div>
              ))}
          </div>
        </div>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl bg-primary-600 p-8 text-center text-white md:p-12">
            ...
            <h3 className="mb-4 text-2xl font-bold">Prêt à transformer votre communication ?</h3>
